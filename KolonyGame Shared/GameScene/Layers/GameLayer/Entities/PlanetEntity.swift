...
class PlanetEntity: GKEntity {
    ...
    init(imageName: String, size: CGSize, contactTestBitMask: UInt32, collisionBitMask: UInt32, physicCategory: UInt32) {
        super.init()
        ...
        self.physicsBodyComponent = PhysicBodyComponent(circleOfRadius: size.height/2, contactTestBitMask: contactTestBitMask, collisionBitMask: collisionBitMask, physicCategory: physicCategory, friction: 0.0, linearDamping: 0.0, restitution: 0.0)
